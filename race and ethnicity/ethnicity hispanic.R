...
nam93_filtered_gen_white <- nam93_filtered_gen[nam93_filtered_gen$RACE == 1, ]
nam93_filtered_gen_black <- nam93_filtered_gen[nam93_filtered_gen$RACE == 2, ]
nam93_filtered_gen_hispanic <- nam93_filtered_gen[nam93_filtered_gen$ETHNIC == 1, ]

nam94_filtered_gen_white <- nam94_filtered_gen[nam94_filtered_gen$RACE == 1, ]
nam94_filtered_gen_black <- nam94_filtered_gen[nam94_filtered_gen$RACE == 2, ]
nam94_filtered_gen_hispanic <- nam94_filtered_gen[nam94_filtered_gen$ETHNIC == 1, ]

nam95_filtered_gen_white <- nam95_filtered_gen[nam95_filtered_gen$RACE == 1, ]
nam95_filtered_gen_black <- nam95_filtered_gen[nam95_filtered_gen$RACE == 2, ]
nam95_filtered_gen_hispanic <- nam95_filtered_gen[nam95_filtered_gen$ETHNIC == 1, ]

nam96_filtered_gen_white <- nam96_filtered_gen[nam96_filtered_gen$RACE == 1, ]
nam96_filtered_gen_black <- nam96_filtered_gen[nam96_filtered_gen$RACE == 2, ]
nam96_filtered_gen_hispanic <- nam96_filtered_gen[nam96_filtered_gen$ETHNIC == 1, ]

nam97_filtered_gen_white <- nam97_filtered_gen[nam97_filtered_gen$RACE == 1, ]
nam97_filtered_gen_black <- nam97_filtered_gen[nam97_filtered_gen$RACE == 2, ]
nam97_filtered_gen_hispanic <- nam97_filtered_gen[nam97_filtered_gen$ETHNIC == 1, ]

nam98_filtered_gen_white <- nam98_filtered_gen[nam98_filtered_gen$RACE == 1, ]
nam98_filtered_gen_black <- nam98_filtered_gen[nam98_filtered_gen$RACE == 2, ]
nam98_filtered_gen_hispanic <- nam98_filtered_gen[nam98_filtered_gen$ETHNIC == 1, ]

nam99_filtered_gen_white <- nam99_filtered_gen[nam99_filtered_gen$RACE == 1, ]
nam99_filtered_gen_black <- nam99_filtered_gen[nam99_filtered_gen$RACE == 2, ]
nam99_filtered_gen_hispanic <- nam99_filtered_gen[nam99_filtered_gen$ETHNIC == 1, ]

nam00_filtered_gen_white <- nam00_filtered_gen[nam00_filtered_gen$RACE == 1, ]
nam00_filtered_gen_black <- nam00_filtered_gen[nam00_filtered_gen$RACE == 2, ]
nam00_filtered_gen_hispanic <- nam00_filtered_gen[nam00_filtered_gen$ETHNIC == 1, ]

nam01_filtered_gen_white <- nam01_filtered_gen[nam01_filtered_gen$RACE == 1, ]
nam01_filtered_gen_black <- nam01_filtered_gen[nam01_filtered_gen$RACE == 2, ]
nam01_filtered_gen_hispanic <- nam01_filtered_gen[nam01_filtered_gen$ETHNIC == 1, ]

nam02_filtered_gen_white <- nam02_filtered_gen[nam02_filtered_gen$RACE == 1, ]
nam02_filtered_gen_black <- nam02_filtered_gen[nam02_filtered_gen$RACE == 2, ]
nam02_filtered_gen_hispanic <- nam02_filtered_gen[nam02_filtered_gen$ETHNIC == 1, ]

nam03_filtered_gen_white <- nam03_filtered_gen[nam03_filtered_gen$RACE == 1, ]
nam03_filtered_gen_black <- nam03_filtered_gen[nam03_filtered_gen$RACE == 2, ]
nam03_filtered_gen_hispanic <- nam03_filtered_gen[nam03_filtered_gen$ETHNIC == 1, ]

nam04_filtered_gen_white <- nam04_filtered_gen[nam04_filtered_gen$RACE == 1, ]
nam04_filtered_gen_black <- nam04_filtered_gen[nam04_filtered_gen$RACE == 2, ]
nam04_filtered_gen_hispanic <- nam04_filtered_gen[nam04_filtered_gen$ETHNIC == 1, ]

nam05_filtered_gen_white <- nam05_filtered_gen[nam05_filtered_gen$RACE == 1, ]
nam05_filtered_gen_black <- nam05_filtered_gen[nam05_filtered_gen$RACE == 2, ]
nam05_filtered_gen_hispanic <- nam05_filtered_gen[nam05_filtered_gen$ETHNIC == 1, ]

nam06_filtered_gen_white <- nam06_filtered_gen[nam06_filtered_gen$RACE == 1, ]
nam06_filtered_gen_black <- nam06_filtered_gen[nam06_filtered_gen$RACE == 2, ]
nam06_filtered_gen_hispanic <- nam06_filtered_gen[nam06_filtered_gen$ETHNIC == 1, ]

nam07_filtered_gen_white <- nam07_filtered_gen[nam07_filtered_gen$RACEUN == 1, ]
nam07_filtered_gen_black <- nam07_filtered_gen[nam07_filtered_gen$RACEUN == 2, ]
nam07_filtered_gen_hispanic <- nam07_filtered_gen[nam07_filtered_gen$ETHUN == 1, ]

nam08_filtered_gen_white <- nam08_filtered_gen[nam08_filtered_gen$RACEUN == 1, ]
nam08_filtered_gen_black <- nam08_filtered_gen[nam08_filtered_gen$RACEUN == 2, ]
nam08_filtered_gen_hispanic <- nam08_filtered_gen[nam08_filtered_gen$ETHUN == 1, ]

nam09_filtered_gen_white <- nam09_filtered_gen[nam09_filtered_gen$RACEUN == 1, ]
nam09_filtered_gen_black <- nam09_filtered_gen[nam09_filtered_gen$RACEUN == 2, ]
nam09_filtered_gen_hispanic <- nam09_filtered_gen[nam09_filtered_gen$ETHUN == 1, ]

nam10_filtered_gen_white <- nam10_filtered_gen[nam10_filtered_gen$RACEUN == 1, ]
nam10_filtered_gen_black <- nam10_filtered_gen[nam10_filtered_gen$RACEUN == 2, ]
nam10_filtered_gen_hispanic <- nam10_filtered_gen[nam10_filtered_gen$ETHUN == 1, ]

nam11_filtered_gen_white <- nam11_filtered_gen[nam11_filtered_gen$RACEUN == 1, ]
nam11_filtered_gen_black <- nam11_filtered_gen[nam11_filtered_gen$RACEUN == 2, ]
nam11_filtered_gen_hispanic <- nam11_filtered_gen[nam11_filtered_gen$ETHUN == 1, ]

nam12_filtered_gen_white <- nam12_filtered_gen[nam12_filtered_gen$RACEUN == 1, ]
nam12_filtered_gen_black <- nam12_filtered_gen[nam12_filtered_gen$RACEUN == 2, ]
nam12_filtered_gen_hispanic <- nam12_filtered_gen[nam12_filtered_gen$ETHUN == 1, ]

nam13_filtered_gen_white <- nam13_filtered_gen[nam13_filtered_gen$RACEUN == 1, ]
nam13_filtered_gen_black <- nam13_filtered_gen[nam13_filtered_gen$RACEUN == 2, ]
nam13_filtered_gen_hispanic <- nam13_filtered_gen[nam13_filtered_gen$ETHUN == 1, ]

nam14_filtered_gen_white <- nam14_filtered_gen[nam14_filtered_gen$RACEUN == 1, ]
nam14_filtered_gen_black <- nam14_filtered_gen[nam14_filtered_gen$RACEUN == 2, ]
nam14_filtered_gen_hispanic <- nam14_filtered_gen[nam14_filtered_gen$ETHUN == 1, ]

nam15_filtered_gen_white <- nam15_filtered_gen[nam15_filtered_gen$RACEUN == 1, ]
nam15_filtered_gen_black <- nam15_filtered_gen[nam15_filtered_gen$RACEUN == 2, ]
nam15_filtered_gen_hispanic <- nam15_filtered_gen[nam15_filtered_gen$ETHUN == 1, ]

nam16_filtered_gen_white <- nam16_filtered_gen[nam16_filtered_gen$RACEUN == 1, ]
nam16_filtered_gen_black <- nam16_filtered_gen[nam16_filtered_gen$RACEUN == 2, ]
nam16_filtered_gen_hispanic <- nam16_filtered_gen[nam16_filtered_gen$ETHUN == 1, ]

###summary statistics data frame for race
#separate 1993-2006, 2007-2016 as differing classifications

race_list_9306 <- list(nam93_filtered_gen, nam94_filtered_gen, nam95_filtered_gen, nam96_filtered_gen, nam97_filtered_gen,
...
frequencies_df_race_9306 <- data.frame(variable = character(),
                                       value = character(),
                                       frequency = numeric(),
                                       percent = numeric(),
                                       dataframename = character(),
                                       stringsAsFactors = FALSE)
for (i in seq_along(race_list_9306)) {
  year <- 1992 + i
  freq_table <- table(race_list_9306[[i]]$RACE)
  ...
  df <- data.frame(variable = variable,
                   ...
                   stringsAsFactors = FALSE)
  frequencies_df_race_9306 <- rbind(frequencies_df_race_9306, df)
}

###remove RACEUN=-9 (NAs) for 2007 to 2016
nam07_filtered_gen <- nam07_filtered_gen[nam07_filtered_gen$RACEUN != -9, ]
nam08_filtered_gen <- nam08_filtered_gen[nam08_filtered_gen$RACEUN != -9, ]
nam09_filtered_gen <- nam09_filtered_gen[nam09_filtered_gen$RACEUN != -9, ]
nam10_filtered_gen <- nam10_filtered_gen[nam10_filtered_gen$RACEUN != -9, ]
nam11_filtered_gen <- nam11_filtered_gen[nam11_filtered_gen$RACEUN != -9, ]
nam12_filtered_gen <- nam12_filtered_gen[nam12_filtered_gen$RACEUN != -9, ]
nam13_filtered_gen <- nam13_filtered_gen[nam13_filtered_gen$RACEUN != -9, ]
nam14_filtered_gen <- nam14_filtered_gen[nam14_filtered_gen$RACEUN != -9, ]
nam15_filtered_gen <- nam15_filtered_gen[nam15_filtered_gen$RACEUN != -9, ]
nam16_filtered_gen <- nam16_filtered_gen[nam16_filtered_gen$RACEUN != -9, ]

frequencies_df_race_0716 <- data.frame(variable = character(),
                                       value = character(),
                                       frequency = numeric(),
                                       percent = numeric(),
                                       dataframename = character(),
...
race_list_0716 <- list(nam07_filtered_gen,
...
for (i in seq_along(race_list_0716)) {
  year <- 2006 + i
  freq_table <- table(race_list_0716[[i]]$RACEUN)
  variable <- "RACEUN"
  value <- names(freq_table)
  frequency <- as.numeric(freq_table)
  percent <- frequency / sum(frequency) * 100
  df2 <- data.frame(variable = variable,
                    value = value,
                    frequency = frequency,
                    percent = percent,
                    dataframename = paste0("nam", year),
                    stringsAsFactors = FALSE)
  frequencies_df_race_0716 <- rbind(frequencies_df_race_0716, df2)
}

#merge frequency tables
frequencies_df_race_9316 <- rbind(frequencies_df_race_9306, frequencies_df_race_0716)
frequencies_df_race_white <- frequencies_df_race_9316[frequencies_df_race_9316$value == 1, ]
frequencies_df_race_black <- frequencies_df_race_9316[frequencies_df_race_9316$value == 2, ]
descr(frequencies_df_race_white)
descr(frequencies_df_race_black)

###summary statistics data frame for ethnicity
ethnic_list_9306 <- list(nam93_filtered_gen, nam94_filtered_gen, nam95_filtered_gen, nam96_filtered_gen, nam97_filtered_gen,
                         nam98_filtered_gen, nam99_filtered_gen, nam00_filtered_gen, nam01_filtered_gen, nam02_filtered_gen,
                         nam03_filtered_gen, nam04_filtered_gen, nam05_filtered_gen, nam06_filtered_gen)

frequencies_df_ethnic_9306 <- data.frame(variable = character(),
                                         value = character(),
                                         frequency = numeric(),
                                         percent = numeric(),
                                         dataframename = character(),
                                         stringsAsFactors = FALSE)
for (i in seq_along(ethnic_list_9306)) {
  year <- 1992 + i
  freq_table <- table(ethnic_list_9306[[i]]$ETHNIC)
  variable <- "ETHNIC"
  value <- names(freq_table)
  frequency <- as.numeric(freq_table)
  percent <- frequency / sum(frequency) * 100
  ...
  df <- data.frame(variable = variable,
                   ...
                   dataframename = paste0("nam", year),
                   stringsAsFactors = FALSE)
  frequencies_df_ethnic_9306 <- rbind(frequencies_df_ethnic_9306, df)
}

###keep only ETHUN = 1 or 2 for 2007 to 2016
nam07_filtered_gen <- nam07_filtered_gen[nam07_filtered_gen$ETHUN %in% c(1, 2), ]
nam08_filtered_gen <- nam08_filtered_gen[nam08_filtered_gen$ETHUN %in% c(1, 2), ]
nam09_filtered_gen <- nam09_filtered_gen[nam09_filtered_gen$ETHUN %in% c(1, 2), ]
nam10_filtered_gen <- nam10_filtered_gen[nam10_filtered_gen$ETHUN %in% c(1, 2), ]
nam11_filtered_gen <- nam11_filtered_gen[nam11_filtered_gen$ETHUN %in% c(1, 2), ]
nam12_filtered_gen <- nam12_filtered_gen[nam12_filtered_gen$ETHUN %in% c(1, 2), ]
nam13_filtered_gen <- nam13_filtered_gen[nam13_filtered_gen$ETHUN %in% c(1, 2), ]
nam14_filtered_gen <- nam14_filtered_gen[nam14_filtered_gen$ETHUN %in% c(1, 2), ]
nam15_filtered_gen <- nam15_filtered_gen[nam15_filtered_gen$ETHUN %in% c(1, 2), ]
nam16_filtered_gen <- nam16_filtered_gen[nam16_filtered_gen$ETHUN %in% c(1, 2), ]

frequencies_df_ethnic_0716 <- data.frame(variable = character(),
                                         value = character(),
                                         frequency = numeric(),
                                         percent = numeric(),
                                         dataframename = character(),
...
ethnic_list_0716 <- list(nam07_filtered_gen,
                         nam08_filtered_gen, nam09_filtered_gen, nam10_filtered_gen, nam11_filtered_gen, nam12_filtered_gen,
                         nam13_filtered_gen, nam14_filtered_gen, nam15_filtered_gen, nam16_filtered_gen)

for (i in seq_along(ethnic_list_0716)) {
  year <- 2006 + i
  freq_table <- table(ethnic_list_0716[[i]]$ETHUN)
  variable <- "ETHUN"
  value <- names(freq_table)
  frequency <- as.numeric(freq_table)
  percent <- frequency / sum(frequency) * 100
  df4 <- data.frame(variable = variable,
                    value = value,
                    frequency = frequency,
                    percent = percent,
                    dataframename = paste0("nam", year),
                    stringsAsFactors = FALSE)
  frequencies_df_ethnic_0716 <- rbind(frequencies_df_ethnic_0716, df4)
}

#merge frequency tables
frequencies_df_ethnic_9316 <- rbind(frequencies_df_ethnic_9306, frequencies_df_ethnic_0716)
frequencies_df_ethnic_9316_hisp<- frequencies_df_ethnic_9316 [frequencies_df_ethnic_9316$value == 1, ]
frequencies_df_ethnic_9316_nonhisp <- frequencies_df_ethnic_9316[frequencies_df_ethnic_9316$value == 2, ]
descr(frequencies_df_ethnic_9316_hisp)
descr(frequencies_df_ethnic_9316_nonhisp)
...
library(survey)
#uncomment this code if filtering for hispanic
nam93_survey <- create_survey_design(nam93_filtered_gen_hispanic)
nam94_survey <- create_survey_design(nam94_filtered_gen_hispanic)
nam95_survey <- create_survey_design(nam95_filtered_gen_hispanic)
nam96_survey <- create_survey_design(nam96_filtered_gen_hispanic)
nam97_survey <- create_survey_design(nam97_filtered_gen_hispanic)
nam98_survey <- create_survey_design(nam98_filtered_gen_hispanic)
nam99_survey <- create_survey_design(nam99_filtered_gen_hispanic)
nam00_survey <- create_survey_design(nam00_filtered_gen_hispanic)
nam01_survey <- create_survey_design(nam01_filtered_gen_hispanic)
nam02_survey <- create_survey_design(nam02_filtered_gen_hispanic)
nam03_survey <- create_survey_design(nam03_filtered_gen_hispanic)
nam04_survey <- create_survey_design(nam04_filtered_gen_hispanic)
nam05_survey <- create_survey_design(nam05_filtered_gen_hispanic)
nam06_survey <- create_survey_design(nam06_filtered_gen_hispanic)
nam07_survey <- create_survey_design(nam07_filtered_gen_hispanic)
nam08_survey <- create_survey_design(nam08_filtered_gen_hispanic)
nam09_survey <- create_survey_design(nam09_filtered_gen_hispanic)
nam10_survey <- create_survey_design(nam10_filtered_gen_hispanic)
nam11_survey <- create_survey_design(nam11_filtered_gen_hispanic)
nam12_survey <- create_survey_design(nam12_filtered_gen_hispanic)
nam13_survey <- create_survey_design(nam13_filtered_gen_hispanic)
nam14_survey <- create_survey_design(nam14_filtered_gen_hispanic)
nam15_survey <- create_survey_design(nam15_filtered_gen_hispanic)
nam16_survey <- create_survey_design(nam16_filtered_gen_hispanic)

#uncomment this code if filtering for black
"nam93_survey <- create_survey_design(nam93_filtered_gen_black)
nam94_survey <- create_survey_design(nam94_filtered_gen_black)
nam95_survey <- create_survey_design(nam95_filtered_gen_black)
nam96_survey <- create_survey_design(nam96_filtered_gen_black)
nam97_survey <- create_survey_design(nam97_filtered_gen_black)
nam98_survey <- create_survey_design(nam98_filtered_gen_black)
nam99_survey <- create_survey_design(nam99_filtered_gen_black)
nam00_survey <- create_survey_design(nam00_filtered_gen_black)
nam01_survey <- create_survey_design(nam01_filtered_gen_black)
nam02_survey <- create_survey_design(nam02_filtered_gen_black)
nam03_survey <- create_survey_design(nam03_filtered_gen_black)
nam04_survey <- create_survey_design(nam04_filtered_gen_black)
nam05_survey <- create_survey_design(nam05_filtered_gen_black)
nam06_survey <- create_survey_design(nam06_filtered_gen_black)
nam07_survey <- create_survey_design(nam07_filtered_gen_black)
nam08_survey <- create_survey_design(nam08_filtered_gen_black)
nam09_survey <- create_survey_design(nam09_filtered_gen_black)
nam10_survey <- create_survey_design(nam10_filtered_gen_black)
nam11_survey <- create_survey_design(nam11_filtered_gen_black)
nam12_survey <- create_survey_design(nam12_filtered_gen_black)
nam13_survey <- create_survey_design(nam13_filtered_gen_black)
nam14_survey <- create_survey_design(nam14_filtered_gen_black)
nam15_survey <- create_survey_design(nam15_filtered_gen_black)
nam16_survey <- create_survey_design(nam16_filtered_gen_black)"

"nam93_survey <- create_survey_design(nam93_filtered_gen_white)
nam94_survey <- create_survey_design(nam94_filtered_gen_white)
nam95_survey <- create_survey_design(nam95_filtered_gen_white)
nam96_survey <- create_survey_design(nam96_filtered_gen_white)
nam97_survey <- create_survey_design(nam97_filtered_gen_white)
nam98_survey <- create_survey_design(nam98_filtered_gen_white)
nam99_survey <- create_survey_design(nam99_filtered_gen_white)
nam00_survey <- create_survey_design(nam00_filtered_gen_white)
nam01_survey <- create_survey_design(nam01_filtered_gen_white)
nam02_survey <- create_survey_design(nam02_filtered_gen_white)
nam03_survey <- create_survey_design(nam03_filtered_gen_white)
nam04_survey <- create_survey_design(nam04_filtered_gen_white)
nam05_survey <- create_survey_design(nam05_filtered_gen_white)
nam06_survey <- create_survey_design(nam06_filtered_gen_white)
nam07_survey <- create_survey_design(nam07_filtered_gen_white)
nam08_survey <- create_survey_design(nam08_filtered_gen_white)
nam09_survey <- create_survey_design(nam09_filtered_gen_white)
nam10_survey <- create_survey_design(nam10_filtered_gen_white)
nam11_survey <- create_survey_design(nam11_filtered_gen_white)
nam12_survey <- create_survey_design(nam12_filtered_gen_white)
nam13_survey <- create_survey_design(nam13_filtered_gen_white)
nam14_survey <- create_survey_design(nam14_filtered_gen_white)
nam15_survey <- create_survey_design(nam15_filtered_gen_white)
nam16_survey <- create_survey_design(nam16_filtered_gen_white)"
...
###1. PEDGEN: create and apply a function to create a data frame for PEDGEN, with means and SE from 1993 to 2016
...
###2. NONPEDGEN: create and apply a function to create a data frame for NONPEDGEN, with means and SE from 1993 to 2016
...
###3. PEDSPEC: create and apply a function to create a data frame for PEDSPEC, with means and SE from 1993 to 2004
...
###4. NONPEDSPEC: create and apply a function to create a data frame for NONPEDSPEC, with means and SE from 1993 to 2016
...
library(readr)
write_csv(mean_CI_df, "C:/Users/aleong/Desktop/NAMCS/Replication/mean_CI_race_hispanic_df.csv")
...
ggplot(mean_CI_df, aes(x = year, y = mean, col = variable, shape = variable, fill=variable)) + #remove fill if grey
  ...
  labs(x = "Year", y = "Proportion of visit records \nfor children <18y, Hispanic only (%)", col = "Variable", shape = "Variable") +
