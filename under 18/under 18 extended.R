...
freq(nam18_ped_counts$PED) #496, corroborated by codebook
...
freq(nam19_ped_counts$PED) #398, corroborated by codebook
...
library(readr)
mean_CI_df <- read_csv("means_under18_1993-2016.csv")
